...
export const RightDrawer = ({ omen }: RightDrawerProps) => {
  const urls = {
    ...
    "woman": "https://1.bp.blogspot.com/-ZOg0qAG4ewU/Xub_uw6q0DI/AAAAAAABZio/MshyuVBpHUgaOKJtL47LmVkCf5Vge6MQQCNcBGAsYHQ/s1600/pose_pien_uruuru_woman.png",
    "nogender": ""
  } as const
  ...
  return (
    <nav className="fixed w-3/10 h-full right-0 top-0 bg-blue-300">
      <select
        name="gender"
        onChange={(e) => setRadio(e.target.value as unknown as keyof typeof urls)}
