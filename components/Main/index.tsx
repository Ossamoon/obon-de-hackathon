        ...
        <div className="absolute top-1/2 transform -translate-y-1/2 w-full bg-white z-10">
          <div className="flex w-full justify-between">
            <div className="w-6/10 bg-white">
              <img src={omens[focusIndex].src} alt="" className="w-full" />
            </div>
            <div className="flex flex-col justify-between flex-grow bg-gray-200">
              <div>
                <span className="ml-2 text-3xl">Test-Title-{focusIndex}</span><br />
              ...
              <div className="flex justify-center">
                <div>
                  <button className="bg-green-200 hover:bg-green-300 m-2 px-12 py-1 text-lg rounded"
                    onClick={() => {
                      console.log("Print")
                    }}>
                    Print
                ...
                <div>
                  <button className="bg-red-200 hover:bg-red-300 m-2 px-4 py-1 text-lg rounded"
                    onClick={() => {
                      setFocusIndex(-1)
                      setIsOverlay(false)
                    }}>
